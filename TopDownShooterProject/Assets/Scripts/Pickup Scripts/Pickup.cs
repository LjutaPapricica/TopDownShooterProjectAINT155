    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        switch (pickupType)
        {
            ...
            case PickupType.Invincible:
                Invincible i = other.gameObject.AddComponent<Invincible>();
                i.time = time;
                break;
            ...
            case PickupType.AttackSpeed:
                AttackSpeed a = other.gameObject.AddComponent<AttackSpeed>();
                a.time = time;
                a.fireSpeed = fireSpeed;
                break;
            ...
            case PickupType.MoveSpeed:
                SpeedBooster s = other.gameObject.AddComponent<SpeedBooster>();
                s.time = time;
                s.speedIncrease = speedIncrease;
                break;
